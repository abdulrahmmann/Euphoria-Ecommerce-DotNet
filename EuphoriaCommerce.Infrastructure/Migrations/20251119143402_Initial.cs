        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HexCode = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValueSql: "GETUTCDATE()"),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SizeName = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagId", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserProfile_FirstName = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    UserProfile_SecondName = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    UserProfile_LastName = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    UserProfile_FullName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    UserProfile_ProfileImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserProfile_Bio = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    UserProfile_Gender = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserProfile_Country = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    UserProfile_City = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BadgeName = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
                    BadgeColor = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValueSql: "GETUTCDATE()"),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BadgeId", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Badge_Product",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductImageId", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductProductTag_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
